...
export default new Vuex.Store({
  state: {
    ...
    descriereCaragiale: "\tCel mai mare dramaturg și scriitor satiric al literaturii noastre, Ion Luca Caragiale, s-a născut la 30 ianuarie 1852 în satul Haimaitare din fostul județ Prahova, ca fiu al lui Luca și al Ecaterinei Caragiale. Primele clase le urmeaza la Ploiești, la Școala Domnească, păstrând o pioasă amintire învățătorului Basil Drăgoșescu, de la care a învățat întâia dată tainele gramaticii și respectul pentru limba românească.\n" +
        ...
        "\tAnul 1873 este important în evoluția lui Caragiale, întrucât acum este prima probă a înclinațiilor sale satirice, debutând la revista umoristică Ghimpele, cu articole si note polemice ascuțite, în care atacă cu frondă juvenilă pe Maiorescu, Macedonski s.a.\n" +
        ...
        "\tÎn 1901 apare volumul Momente și schițe și în același an are loc cunoscuta acuzație de plagiat adusă de Caion Alexandru Ionescu, publicist mediocru, necinstit și amator de scandaluri, infierat în fulminanta pledoarie a lui Delavrancea.\n" +
        "\tÎn 1904, beneficiind de o moștenire considerabilă, Caragiale pleacă la Berlin, unde se va stabili până  la moarte. Plecarea lui din țară nu trebuie privită cu superficialitate, ca fiind simplu rezultat al unei moșteniri.\n" +
        ...
        "\tI.L.Caragiale moare la Berlin, în 22 iunie 1912, lăsând în urma sa o operă bogată și strălucitoare, o adevarată oglindă a societății românești de la sfârșitul secolului al XIX-lea.\n" +
        "\n" +
    ...
    descriereMaiorescu: "\tTitu Liviu Maiorescu a fost un academician, avocat, critic literar, eseist, estet, filosof, pedagog, politician și scriitor român mason, prim-ministru al României între 1912 și 1914, ministru de interne, membru fondator al Academiei Române.\n" +
        ...
        "\tTotodată, Titu Maiorescu are şi câteva articole individuale, exemplu fiind “Eminescu şi poeziile lui”, articol în care se prezintă viaţa lui Mihai Eminescu, poet sub cărui auspicii va sta întreg secolul XX, şi “Comediile d-lui Caragiale”, articol în care apară operele dramaturgului de critica lui Constantin Dobrogeanu Gherea, definind moralitatea drept fiind “o ficţiune, care scoate pe omul impresionabil în afară şi mai presus de interesele lumii”.\n" +
